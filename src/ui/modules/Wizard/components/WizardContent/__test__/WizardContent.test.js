...
describe('WizardContent', () => {
    ...
    it('it should show the alternative text when the component from step 1 is displayed on the screen', () => {
        //Arrange
        const step = 1;
        const contextData = {
            currentStep: step
    ...
    it('it should show the text when the component from step 2 is displayed on the screen', () => {
        //Arrange
        const step = 2;
        const contextData = {
            currentStep: step
    ...
    it('it should show the text when the component from step 3 is displayed on the screen and has an KO ', () => {
        //Arrange
        const step = 3;
        const contextData = {
            currentStep: step
